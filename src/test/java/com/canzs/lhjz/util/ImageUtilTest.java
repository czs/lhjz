...
import com.canzs.lhjz.util.ImageUtil;
...
public class ImageUtilTest {
	...
	public void test() {
		...
		ImageUtil.pressImage("G:\\imgtest\\sy.jpg", "G:\\imgtest\\test1.jpg", 0, 0, 0.5f);
		ImageUtil.pressText("我是文字水印", "G:\\imgtest\\test1.jpg", "黑体", 36, Color.white, 80, 0, 0, 0.3f);
		ImageUtil.resize("G:\\imgtest\\test1.jpg", 500, 500, true);
	}
