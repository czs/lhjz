package com.canzs.lhjz.interceptor;
...
public class SessionInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		// Object attribute =
		// request.getSession().getAttribute(SysConstant.SESSION_OBJECT);
		//
		// if (attribute == null) {
		//
		...
		// WebUtil.writeResult(response, new ResultMsg(false, new Msg("1000",
		// false, "会话过期,请重新登录!")));
		// } else {
		//
